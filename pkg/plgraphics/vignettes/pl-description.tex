...
\hlstd{dd}\hlopt{$}\hlstd{distance[}\hlnum{2}\hlstd{]} \hlkwb{<-} \hlnum{500}
...
\begin{alltt}
\hlkwd{data}\hlstd{(d.blast)}
\hlstd{dd} \hlkwb{<-} \hlkwd{plsubset}\hlstd{(d.blast,} \hlkwd{as.numeric}\hlstd{(location)}\hlopt{%in%}\hlnum{1}\hlopt{:}\hlnum{3}\hlstd{)}
...
\item 
  ...
  \T{pl.envir}.
\item
  There is a list \T{pl.optionsDefault} in the package. It collects the
...
\item
  the list \T{pl.optionsDefault} in the package \T{plgraphics}
...
\begin{kframe}\begin{alltt}
\hlkwd{table}\hlstd{(pl.envir}\hlopt{$}\hlstd{pldata[,}\hlstr{".pch."}\hlstd{])}
\end{alltt}
\begin{verbatim}
## 
##  1  2  3 
...
\hlkwd{attr}\hlstd{(dd}\hlopt{$}\hlstd{Sepal.Length,} \hlstr{"grid"}\hlstd{)} \hlkwb{<-} \hlkwd{seq}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{8}\hlstd{,}\hlnum{0.5}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{pl.optionsDefault}\hlopt{$}\hlstd{colors}
\end{alltt}
\begin{verbatim}
