...
\Tit{Function \T{inference}.}
This function generates statistics describing relevance and significance 
for many situations, mainly for regression models. 
...
print(rr)
@ 
See \T{?print.printInference} for details.

%% ============================================================================
\section{Examples}
This section documents the examples that appear in the basic reference.
